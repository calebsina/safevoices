                                    ...
                                    <div class="sl-input sl-flex-1 sl-relative">
                                        <?php if(str_ends_with($parameter->type, '[]')): ?>
                                            <input aria-label="<?php echo e($name); ?>" name="<?php echo e($name); ?>"
                                                   ...
                                                   placeholder="<?php echo e($parameter->description); ?>"
                                                   value="<?php echo e(json_encode($parameter->example, JSON_HEX_TAG | JSON_HEX_AMP)); ?>" data-component="query"
                                                   class="sl-relative sl-w-full sl-h-md sl-text-base sl-pr-2.5 sl-pl-2.5 sl-rounded sl-border-transparent hover:sl-border-input focus:sl-border-primary sl-border"
                                            >
                                        <?php else: ?>
                                            <input aria-label="<?php echo e($name); ?>" name="<?php echo e($name); ?>"
                    ...
                    <div class="sl-panel__content-wrapper sl-bg-canvas-100 children" role="region">
                        <?php if($endpoint->hasJsonBody()): ?>
                            <div class="TextRequestBody sl-p-4">
                                ...
                                ><?php echo json_encode($endpoint->getSampleBody(), JSON_PRETTY_PRINT | JSON_HEX_TAG | JSON_HEX_AMP); ?></div>
                            </div>
                        <?php else: ?>
                            <div class="ParameterGrid sl-p-4">
                                        ...
                                        <div class="sl-input sl-flex-1 sl-relative">
                                            ...
                                            <?php elseif(str_ends_with($parameter->type, '[]')): ?>
                                                <input aria-label="<?php echo e($name); ?>" name="<?php echo e($name); ?>"
                                                       id="bodyparam-<?php echo e($endpoint->endpointId()); ?>-<?php echo e($name); ?>"
                                                       placeholder="<?php echo e($parameter->description); ?>"
                                                       value="<?php echo e(json_encode($parameter->example, JSON_HEX_TAG | JSON_HEX_AMP)); ?>" data-component="body"
                                                       class="sl-relative sl-w-full sl-h-md sl-text-base sl-pr-2.5 sl-pl-2.5 sl-rounded sl-border-transparent hover:sl-border-input focus:sl-border-primary sl-border"
                                                >
                                            <?php else: ?>
                                                <input aria-label="<?php echo e($name); ?>" name="<?php echo e($name); ?>"
...
<?php /**PATH D:\caleb\api\safevoice-api\vendor\knuckleswtf\scribe\resources\views\themes\elements\try_it_out.blade.php ENDPATH**/ ?>