            ...
            <div title="<?php echo rtrim($baseUrl, '/') . '/'. ltrim($endpoint->uri, '/'); ?>"
                ...
                >
                    ...
                    <div class="sl-flex sl-overflow-x-hidden sl-text-lg sl-select-all">
                        ...
                        <?php endif; ?>
                        <?php if($endpoint->metadata->deprecated === true): ?>
                            <div class="sl-font-prose sl-font-semibold sl-px-1.5 sl-py-0.5 sl-text-on-primary sl-rounded-lg"
                                 style="background-color: darkgoldenrod"
                            >deprecated
                            </div>
                        <?php endif; ?>
                        <?php if(is_string($endpoint->metadata->deprecated)): ?>
                            <div class="sl-font-prose sl-font-semibold sl-px-1.5 sl-py-0.5 sl-text-on-primary sl-rounded-lg"
                                 style="background-color: darkgoldenrod"
...
<?php /**PATH D:\caleb\api\safevoice-api\vendor\knuckleswtf\scribe\resources\views\themes\elements\endpoint.blade.php ENDPATH**/ ?>